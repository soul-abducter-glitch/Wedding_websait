...
const en = {
  ...
  reviewsPage: {
    ...
    form: {
      ...
      subtitle: "Share a few words about your experience — the review will appear on the site automatically.",
      names: "Names",
      namesPlaceholder: "Anna & Dmitry",
      location: "Location",
      locationPlaceholder: "City / Country",
      text: "Review text",
      textPlaceholder: "How the shoot went, what you liked and remember most",
      contact: "Contact (not published)",
      contactPlaceholder: "Email or phone (optional)",
      contactHint: "Contact details are only for me to reach you, they are not shown on the site.",
      cta: "Send review",
      sending: "Sending...",
      success: "Thank you! Your review has been sent and will appear on the site shortly.",
      error: "Failed to send the review. Please try again.",
    },
  },
  faqPage: {
    eyebrow: "FAQ",
